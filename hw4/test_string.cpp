...
void test_relationals()
{
	...
	cout << "test !=: " << (s1 != s2) << " (Should be 0)" << endl;
	cout << "test >: " << (s1 > s2) << " (Should be 0)" << endl;
	cout << "test >=: " << (s1 >= s2) << " (Should be 1)" << endl;
	cout << "test <: " << (s1 < s2) << " (Should be 0)" << endl;
	cout << "test <=: " << (s1 <= s2) << " (Should be 1)" << endl;
	...
	cout << "test !=: " << (s3 != s4) << " (Should be 1)" << endl;
	cout << "test >: " << (s3 > s4) << " (Should be 0)" << endl;
	cout << "test >=: " << (s3 >= s4) << " (Should be 0)" << endl;
	cout << "test <: " << (s3 < s4) << " (Should be 1)" << endl;
	cout << "test <=: " << (s3 <= s4) << " (Should be 1)" << endl;
	...
	cout << "test !=: " << (s5 != s6) << " (Should be 1)" << endl;
	cout << "test >: " << (s5 > s6) << " (Should be 1)" << endl;
	cout << "test >=: " << (s5 >= s6) << " (Should be 1)" << endl;
	cout << "test <: " << (s5 < s6) << " (Should be 0)" << endl;
	cout << "test <=: " << (s5 <= s6) << " (Should be 0)" << endl;
...
void test_index_of()
{
	...
	String pattern3("oo");
	String s3("hello");
	cout << "The index of \"" << pattern3 << "\" in \"" << s3 << "\" is: " << s3.indexOf(pattern1) << endl;
}
